...
const searchImageTool = tool({
  ...
  execute: async ({ query, perPage = 5 }) => {
    const accessKey = process.env.UNSPLASH_ACCESS_KEY;
    // console.log("...execute searchImageTool", accessKey);
    ...
    console.log("...execute searchImageTool", imageResults, { query });
    return imageResults;
  },
});
